                    ...
                    <>
                        ...
                        <div className="metrics-grid">
                            ...
                            <div className="metric-card green">
                                <div className="metric-label">สัญญาณ</div>
                            ...
                            <div className="metric-card purple">
                                <div className="metric-label">ระดับความมั่นใจ</div>
                        ...
                        <div className="card" style={{ marginBottom: 20, borderLeft: '3px solid var(--accent-cyan)' }}>
                            <div className="card-header">
                                ...
                                {!aiLoading && aiExplanation && (
                                    <button className="btn btn-secondary" style={{ fontSize: 11 }} onClick={() => fetchAIExplanation(prediction)}>
                                        🔄 วิเคราะห์ใหม่
                                    </button>
                                )}
                            </div>
                            {aiLoading ? (
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 0' }}>
                                    ...
                                    <span style={{ color: 'var(--text-secondary)', fontSize: 14 }}>🧠 AI กำลังวิเคราะห์...</span>
                                </div>
                            ) : aiExplanation ? (
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>กด Predict เพื่อรับการวิเคราะห์จาก AI</p>
                            )}
                        </div>
                        ...
                        <div className="grid-2">
                                ...
                                {pred.length > 0 && (
                                    <PlotChart
                                        ...
                                        layout={{
                                            ...
                                            yaxis: { gridcolor: '#1e293b', title: `Price (${getCurrencyInfo(stocks, selected).label})` },
                            ...
                            {/* Prediction Table */}
                            <div className="card">
                                <div className="card-header"><span className="card-title">📊 5-Day Forecast</span></div>
                                <table className="data-table">
                                    <thead><tr><th>วันที่</th><th>ราคาทำนาย</th><th>Confidence</th></tr></thead>
                                    <tbody>
                                        {pred.map((p, i) => (
                                            <tr key={i}>
                                                <td>{p.date}</td>
